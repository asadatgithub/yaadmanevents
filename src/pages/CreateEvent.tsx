      ...
      <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-lg text-center">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-10">
            ...
            <h2 className="text-2xl font-extrabold text-gray-900 mb-2">Event Created!</h2>
            <p className="text-gray-500 mb-8">
              Your event has been created successfully. Contact the admin via WhatsApp to get your QR code.
            </p>
            <Link
              to="/dashboard"
            ...
            <div className="mt-10 pt-8 border-t border-gray-100">
              <p className="text-sm text-gray-400 mb-4 uppercase tracking-wide font-medium">Follow 1Legend</p>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-2xl mx-auto px-4 py-8">
        <div className="mb-8">
          <Link to="/dashboard" className="text-sm text-jamaica-green hover:text-jamaica-green-dark font-medium inline-flex items-center gap-1 mb-4">
            ...
            <div className="border-2 border-dashed border-gray-200 rounded-xl p-6 text-center hover:border-jamaica-green/50 transition-colors">
              {preview ? (
                <div className="relative">
                  ...
                  <button
                    type="button"
                    onClick={() => { setBannerFile(null); setPreview(null) }}
