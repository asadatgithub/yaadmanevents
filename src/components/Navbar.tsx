...
export default function Navbar() {
  const { user, profile, signOut, isAdmin, isScanner } = useAuth();
        ...
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center gap-2">
            ...
            <div className="hidden sm:flex items-center gap-1">
              <span className="text-jamaica-gold font-extrabold text-lg tracking-tight">
                PARTYSPOT
              </span>
          ...
          {isAdmin ? (
            <>
              <Link
                ...
                className="block py-2 text-gray-300 hover:text-jamaica-gold text-sm"
              >
                Admin Dashboard
              </Link>
              <button
                ...
                className="block py-2 text-jamaica-green text-sm font-medium"
              >
                Sign Out
              </button>
            </>
